    ...
    // remote invocation methods ----------------------------------------------
	 ...
	 public List<ItemView> getItems(String productId) throws InvalidItemId_Exception {
		 if(productId==null||productId.trim().equals(""))
			 throw new InvalidItemId_Exception("Invalid ItemId",new InvalidItemId());
	 ...
	 public ShoppingResultView buyCart(String cartId, String creditCardNr)
		 ...
		 if(cartId==null || cartId.trim().equals(""))
			 throw new InvalidCartId_Exception("Invalid cartId", new InvalidCartId());
		 if(creditCardNr==null || creditCardNr.trim().equals(""))
			 throw new InvalidCreditCard_Exception("Invalid creditCardNr", new InvalidCreditCard());
	 ...
	 public void addToCart(String cartId, ItemIdView itemId, int itemQty) throws InvalidCartId_Exception,
		 ...
		 if(cartId==null || cartId.trim().equals(""))
			 throw new InvalidCartId_Exception("Invalid cartId", new InvalidCartId());
		 if(itemId==null || itemId.getProductId()==null)
			 throw new InvalidItemId_Exception("Invalid itemId", new InvalidItemId());
		 if(itemId.getProductId().trim().equals(""))
			 throw new InvalidItemId_Exception("Invalid itemId", new InvalidItemId());
		 if(itemQty<=0)
			 throw new InvalidQuantity_Exception("Invalid itemQty", new InvalidQuantity());
